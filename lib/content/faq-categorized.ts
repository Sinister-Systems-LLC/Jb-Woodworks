...
export const faqCategorized: FaqCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "JB Woodworks has been building in Orlando since 2025 — decks, docks, pergolas, custom furniture, and commercial fabrication. Every project is designed and built in-house. No subcontracted crews, no shortcuts on materials, no surprises mid-build."
      }
    ]
  },
  {
