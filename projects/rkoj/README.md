...
**Version:** v1.1.0 (2026-05-21) — see `CHANGELOG.md`.
...
**Component count:** ~23 entries in `MANIFEST.json` after v1.1.0 (forge sub-pieces + 5 newly-relocated `sinister-*` projects via GG2 Phase 3).
