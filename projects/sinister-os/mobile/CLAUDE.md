# CLAUDE.md — Sinister OS :: Mobile sub-lane (Pixel 6a)

> **Author:** RKOJ-ELENO :: 2026-05-24
> **Sub-lane:** `sinister-os/mobile` :: branch `agent/sinister-os-mobile/<short-topic>` :: purple accent
> **Lane heartbeat:** `_shared-memory/heartbeats/sinister-os.json` (shared with PC sub-lane post-consolidation)
> **PROGRESS log:** `_shared-memory/PROGRESS/Sinister OS.md` (shared; mobile entries merged from former `Sinister OS Mobile.md` 2026-05-24)

This file is the lane discipline for any EVE session opened with the working directory at `D:\Sinister Sanctum\projects\sinister-os\mobile\`. It inherits from `D:\Sinister Sanctum\CLAUDE.md` (Sanctum master) AND `D:\Sinister Sanctum\projects\sinister-os\CLAUDE.md` (parent sinister-os lane) — read those first, then this file.

> **Consolidated 2026-05-24T22:10Z** — formerly `projects/sinister-os-mobile/`. Operator directive: *"combine project sinister os and sinister os mobile."* The sinister-os-mobile lane is now the mobile sub-lane of sinister-os; both PC and Mobile share picker entry `sinister-os` and PROGRESS log `Sinister OS.md`. Branch namespace `agent/sinister-os-mobile/*` is preserved for branch hygiene; brain doctrine slug `sinister-os-mobile-doctrine-2026-05-24` preserved for stable cross-references.
...
- `projects/sinister-os/mobile/` — all of it (formerly `projects/sinister-os-mobile/`; consolidated under sinister-os 2026-05-24)
