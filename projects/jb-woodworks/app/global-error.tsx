      ...
      <body style={{ background: "#080808", color: "rgba(255,255,255,0.85)", fontFamily: "Inter, sans-serif", margin: 0, padding: 0 }}>
        <main style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem", textAlign: "center" }}>
          <div style={{ maxWidth: 560 }}>
            <p style={{ fontSize: "0.7rem", letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--accent)", fontWeight: 700, margin: 0 }}>JB Woodworks &middot; Critical Error</p>
            ...
            <p style={{ color: "rgba(255,255,255,0.6)", lineHeight: 1.7, marginBottom: "1.5rem" }}>
              An error reached the root of the application. Reload the page, or call <a style={{ color: "var(--accent)" }} href="tel:4075611453">(407) 561-1453</a>.
            </p>
            <button
              type="button"
              onClick={() => reset()}
              style={{ background: "var(--accent)", color: "#080808", border: 0, padding: "0.9rem 2rem", fontSize: "0.82rem", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", cursor: "pointer", borderRadius: 6 }}
            >
              Try again
            </button>
            {error?.digest && (
