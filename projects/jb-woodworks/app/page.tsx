...
export default function Home() {
  // Recent work preview: lead with the New Balance Ã— Foot Locker reveal (per
  ...
  return (
    <>
      ...
      {/* Commercial builds â€” moved above What We Do per operator. Anchored on a real retail display project. */}
      <CommercialFeature />

      {/* Smooth transition strip â€” CommercialFeature dark â†’ Services dark */}
      ...
      <section id="services" className="py-24 sm:py-36 bg-ink-2 relative overflow-hidden">
        {/* Nano Banana atmospheric â€” walnut tabletop. Lower opacity, right-edge fade for variety. */}
        <div
          aria-hidden
        ...
        <div className="container-site relative">
          {/* Vertical chapter mark â€” left rail */}
      ...
      {/* Portfolio feature â€” operator asked for a redo. Header now sits on a
      ...
      {/* FAQ â€” tabbed accordion. Italic gold eyebrow, large letter-spaced
      ...
      {/* Closing CTA â€” operator asked for a fresh background. Drops the bright
      ...
      <section className="py-24 sm:py-32 relative overflow-hidden bg-[#080808]">
        <div aria-hidden className="absolute inset-0 pointer-events-none" style={{
          background: "radial-gradient(120% 80% at 78% 90%, rgba(var(--accent-rgb),0.30), rgba(var(--accent-rgb),0.06) 30%, transparent 60%)"
        }} />
        <div aria-hidden className="absolute inset-0 pointer-events-none" style={{
        ...
        <div className="container-site relative">
          <p className="font-mono text-[0.62rem] tracking-[0.45em] uppercase text-cream-30 mb-6 text-center">
            ...
            One number Â· One shop Â· No salespeople
