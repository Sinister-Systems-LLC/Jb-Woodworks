# Sinister-Workstation-Setup

**Source (junctioned):** `C:\Users\Zonia\Desktop\Sinister-Workstation-Setup`
...
Open `D:\Sinister\01_Projects\Sinister\Sinister-Workstation-Setup\source\` in your editor (VSCode / etc.). It's a transparent junction back to the canonical Desktop location — git, builds, bats, everything works.
