...
**Source (junctioned):** `C:\Users\Zonia\Desktop\Sinister iMessage Bridge`
**Hub memory:** _(No hub memory entry yet — minor project.)_

## One-line state

iMessage bridging (Mac-side relay).

## How to work on this

Open `D:\Sinister\01_Projects\Sinister\Sinister-iMessage-Bridge\source\` in your editor (VSCode / etc.). It's a transparent junction back to the canonical Desktop location — git, builds, bats, everything works.
