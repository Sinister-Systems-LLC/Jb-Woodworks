...
**Source (junctioned):** `C:\Users\Zonia\Desktop\Sinister Tiktok EMU.API`
**Hub memory:** See [hub memory](../../../Sinister Skills/01_MEMORY/sinister-tiktok-emu/) — \SESSION-START.md\ + \RESUME.md\ + \WHERE-I-STOPPED.md\.

## One-line state

TikTok sister-track. RESUME-HERE.md (213 KB) is canonical pickup.

## How to work on this

Open `D:\Sinister\01_Projects\Sinister\Sinister-TikTok-EMU\source\` in your editor (VSCode / etc.). It's a transparent junction back to the canonical Desktop location — git, builds, bats, everything works.
...
- Hub capsule: `..\..\..\Sinister Skills\03_PROJECTS\sinister-tiktok-emu.md`
