...
**Source (junctioned):** `C:\Users\Zonia\Desktop\Snap Signer`
**Hub memory:** See [hub memory](../../../Sinister Skills/01_MEMORY/snap-signer/) — \SESSION-START.md\ + \RESUME.md\ + \WHERE-I-STOPPED.md\.

## One-line state

Phone-stack hunt. Pure-API SS03 wall. Yurikey52 + PI 0/3 blockers.

## How to work on this

Open `D:\Sinister\01_Projects\Sinister\Snap-Signer\source\` in your editor (VSCode / etc.). It's a transparent junction back to the canonical Desktop location — git, builds, bats, everything works.
...
- Hub capsule: `..\..\..\Sinister Skills\03_PROJECTS\snap-signer.md`
