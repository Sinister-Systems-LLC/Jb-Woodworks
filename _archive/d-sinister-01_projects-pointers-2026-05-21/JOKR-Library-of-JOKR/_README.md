...
**Source (junctioned):** `C:\Users\Zonia\Desktop\Library-of-JOKR`
**Group:** [JOKR](../)

## One-line state

Subdomain-organized JOKR reference aggregation. 5611 .md cross-refs.

## How to work on this

Open `D:\Sinister\01_Projects\JOKR\Library-of-JOKR\source\` in your editor. Junction routes transparently to canonical Desktop location.

## Vault entry

Open `_vault/` in Obsidian.

## Cross-references

- Group navigator: `..\_README.md`
- Hub: `..\..\..\Sinister Skills\`
