...
**Source (junctioned):** `C:\Users\Zonia\Desktop\Sinister Bumble EMU.API`
**Hub memory:** See [hub memory](../../../Sinister Skills/01_MEMORY/sinister-bumble-emu/) — \SESSION-START.md\ + \RESUME.md\ + \WHERE-I-STOPPED.md\.

## One-line state

Bumble EMU API. Newer same-shape track as Snap+TikTok.

## How to work on this

Open `D:\Sinister\01_Projects\Sinister\Sinister-Bumble-EMU\source\` in your editor (VSCode / etc.). It's a transparent junction back to the canonical Desktop location — git, builds, bats, everything works.
...
- Hub capsule: `..\..\..\Sinister Skills\03_PROJECTS\sinister-bumble-emu.md`
