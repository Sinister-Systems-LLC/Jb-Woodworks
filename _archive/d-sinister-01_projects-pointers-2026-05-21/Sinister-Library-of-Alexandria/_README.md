...
**Source (junctioned):** `C:\Users\Zonia\Desktop\Sinister Library Of Alexandria`
**Hub memory:** See [hub memory](../../../Sinister Skills/01_MEMORY/library-of-alexandria/) — \SESSION-START.md\ + \RESUME.md\ + \WHERE-I-STOPPED.md\.

## One-line state

Mirror/aggregation of Snap Signer + adjacent. Most recent anchor: 2026-05-17 PM late (Detector v0.95.0).

## How to work on this

Open `D:\Sinister\01_Projects\Sinister\Library-of-Alexandria\source\` in your editor (VSCode / etc.). It's a transparent junction back to the canonical Desktop location — git, builds, bats, everything works.
...
- Hub capsule: `..\..\..\Sinister Skills\03_PROJECTS\library-of-alexandria.md`
