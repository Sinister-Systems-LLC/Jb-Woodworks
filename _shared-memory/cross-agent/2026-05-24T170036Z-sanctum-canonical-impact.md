...
**Origin:** lane 'sanctum' on branch 'agent/sinister-os-mobile/p0-spec-2026-05-24' / commit '236f27b'
**Subject:** 'sinister-os: CachyOS-base jerry-rig path + Sinister overlay + auto-install + EVE-OS integration'
**Timestamp:** 2026-05-24T1700Z UTC
...
- 'automations/canonical-protections-check.ps1'  automations/canonical-protections-check.ps1 | 10 ++++++++++
