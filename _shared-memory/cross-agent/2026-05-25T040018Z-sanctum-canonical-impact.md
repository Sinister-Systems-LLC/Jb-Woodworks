...
**Origin:** lane 'sanctum' on branch 'agent/sinister-os/iter15-doctrine-adopt-2026-05-25' / commit '1c6e7b6'
**Subject:** 'sinister-os (sanctum-promoted) iter-17: EVE.exe arrow-key uniform nav (project picker) + render_picker cursor'
**Timestamp:** 2026-05-25T0400Z UTC
